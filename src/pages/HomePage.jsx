...
const HomePage = () => {
  ...
  const testimonials = [
    ...
    {
      text: "Hace un año que empecé con la doctora Michielan. Me animé a hacerlo ya que estaba pasando un momento difícil en mi vida, hoy puedo decir que fue un gran acierto.",
      author: "Daniel",
    },
    {
